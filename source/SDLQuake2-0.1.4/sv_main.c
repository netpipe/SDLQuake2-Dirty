...
static void SV_UpdateWindowTitle (cvar_t *cvar, char *old, char *newvalue)
{
	...
	{
		char buff[512];
//		Com_sprintf (buff, sizeof(buff), "%s - SDLQuake2 " VERSION " (port %d)", newvalue, server_port);
...
void SV_Init (void)
{
	...
	hostname = Cvar_Get ("hostname", "Unnamed SDLQuake2 Server", CVAR_SERVERINFO | CVAR_ARCHIVE);
